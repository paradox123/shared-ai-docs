...
Konkrete Kandidaten werden ausserhalb dieser produktneutralen Standarddefinition gepflegt:

- [`docs/spec-goldstandard-candidates.md`](spec-goldstandard-candidates.md)

Die Kandidatenliste ist ein Lern- und Bewertungsartefakt. Sie setzt keinen Referenzstatus und fuehrt keine pauschale Migration alter Specs aus.
