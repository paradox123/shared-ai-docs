Session Title: RSW-C1: Implementation - RSW-C1 Write the first MD-E2E-5 output line and child e
...
- Control Index / Queue: 
- Handoff File: tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/handoffs/rsw-c1-handoff.md
...
- Scope Summary: Write the first MD-E2E-5 output line and child evidence.
- Non-Goals: Do not write values 2, 3, 4, or 5; do not launch other sessions; do not edit controller files.
- Allowed Write-Set: tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/target/output/count.txt; tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/delivery-evidence/rsw-c1/**; tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/closeout/children/rsw-c1.json
...
Write exactly `1\n` to `tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/target/output/count.txt`.
...
- `tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/delivery-evidence/rsw-c1/delivery.json`
- `tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/closeout/children/rsw-c1.json`

After writing the output, write delivery and closeout JSON with `target_id: "RSW-C1"`, `final_status: "ran-target"`, and `closeout_status: "closed"`.
