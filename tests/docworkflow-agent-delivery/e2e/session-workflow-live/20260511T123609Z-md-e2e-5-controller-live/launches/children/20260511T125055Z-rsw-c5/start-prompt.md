Session Title: RSW-C5: Implementation - RSW-C5 Append the fifth MD-E2E-5 output line and child
...
- Control Index / Queue: 
- Handoff File: tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/handoffs/rsw-c5-handoff.md
...
- Scope Summary: Append the fifth MD-E2E-5 output line and child evidence.
- Non-Goals: Do not write values 1, 2, 3, or 4; do not launch other sessions; do not edit controller files.
- Allowed Write-Set: tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/target/output/count.txt; tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/delivery-evidence/rsw-c5/**; tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/closeout/children/rsw-c5.json
...
- `tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/delivery-evidence/rsw-c5/delivery.json`
- `tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T123609Z-md-e2e-5-controller-live/closeout/children/rsw-c5.json`

After writing the output, write delivery and closeout JSON with `target_id: "RSW-C5"`, `final_status: "ran-target"`, and `closeout_status: "closed"`.
