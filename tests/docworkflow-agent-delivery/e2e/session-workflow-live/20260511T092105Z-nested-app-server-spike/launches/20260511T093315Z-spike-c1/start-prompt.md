Session Title: SPIKE-C1: Implementation - spike-c1
...
- Target ID: SPIKE-C1
- Target Role: child
- Target Spec: child-specs/spike-c1.md
- Control Index / Queue: tests/docworkflow-agent-delivery/e2e/session-workflow-live/20260511T092105Z-nested-app-server-spike/orchestration-pack.md
