...
- Child: SYNC-1
- Child Spec: tests/sync-child-handoff/fixtures/preserve-notes/child-spec.md
- Child Index / Queue: /Users/dh/Documents/DanielsVault/_shared/shared-ai-docs/tests/sync-child-handoff/fixtures/preserve-notes/control-index.md section `Child Index`
- Handoff File: /Users/dh/Documents/DanielsVault/_shared/shared-ai-docs/tests/sync-child-handoff/fixtures/preserve-notes/child-session-handoff.md
...
- Allowed Write-Set: `skills-repo/tools/SyncChildHandoff.cs`; `tests/sync-child-handoff/fixtures/preserve-notes/**`
...
- Evidence / OpenSpec: openspec/changes/agent-delivery-sync-child-handoff/; tests/sync-child-handoff/fixtures/preserve-notes/evidence.json
- Retained Evidence: tests/sync-child-handoff/fixtures/preserve-notes/evidence.json
...
Manual note that must survive sync.

- Keep this bullet exactly.
