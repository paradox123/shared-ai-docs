...
- Child: SYNC-1
- Child Spec: tests/sync-child-handoff/fixtures/approx-write-set/child-spec.md
- Child Index / Queue: /Users/dh/Documents/DanielsVault/_shared/shared-ai-docs/tests/sync-child-handoff/fixtures/approx-write-set/control-index.md section `Child Index`
- Handoff File: /Users/dh/Documents/DanielsVault/_shared/shared-ai-docs/tests/sync-child-handoff/fixtures/approx-write-set/child-session-handoff.md
...
- Allowed Write-Set: TBD and related files etc.
...
- Evidence / OpenSpec: openspec/changes/agent-delivery-sync-child-handoff/; tests/sync-child-handoff/fixtures/approx-write-set/evidence.json
- Retained Evidence: tests/sync-child-handoff/fixtures/approx-write-set/evidence.json
