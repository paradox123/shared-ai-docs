...
- Retained Evidence: hardening evidence is the synchronized child spec, Child Index row, readiness validator result and queued launch evidence `_specs/agent-delivery-session-launches/20260509T050712Z-md-e2e-1/evidence.json`.
