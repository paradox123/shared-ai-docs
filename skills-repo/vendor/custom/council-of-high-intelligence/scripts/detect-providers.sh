...
# Anthropic is not a native provider in Codex. Keep an unavailable entry so
# shared configs can mention it without making Codex count it as routable.
providers+=("$(json_provider "anthropic" "false" "unavailable_in_codex" "not_available" '')")
