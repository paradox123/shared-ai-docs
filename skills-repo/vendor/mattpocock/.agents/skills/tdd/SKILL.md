...
When the shape of the interface is itself in question (how deep the module is, where the seam belongs, or what the interface should expose), call the Skill tool with "codebase-design" before selecting the seam. It is the shared source of the module, interface, depth, seam, adapter, leverage, and locality terms.
