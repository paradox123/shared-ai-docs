...
| `tests/docworkflow-agent-delivery/scripts/run-contract-checks.sh all --keep` | pass | `tests/docworkflow-agent-delivery/e2e/evidence/20260509T082132Z-all/mock-e2e-summary.json`; compatibility command produced mock-only summary evidence. |
...
| `openspec archive -y docworkflow-agent-mock-e2e-md-e2e-3-standard-gate-migration` | pass | Archived as `openspec/changes/archive/2026-05-09-docworkflow-agent-mock-e2e-md-e2e-3-standard-gate-migration/`. |
| `openspec validate docworkflow-agent-delivery-testsuite --strict` | pass | Canonical specification is valid after archive. |
...
- Compatibility shim run: `tests/docworkflow-agent-delivery/e2e/evidence/20260509T082132Z-all/mock-e2e-summary.json`
