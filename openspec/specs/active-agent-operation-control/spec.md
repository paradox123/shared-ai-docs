# active-agent-operation-control Specification

## Purpose
Define durable, authorized control of active agent attempts in the isolated work-package pilot, including ordered commands, process fencing, scoped cancellation, recovery and observable responses.
