# real-codex-runtime-gate Specification

## Purpose
Verify the pinned real Codex runtime in an isolated disposable repository before
admitting issue work, preserving complete result validation, recoverable session
identity and authorized native continuation in the Microsoft Agent Framework pilot.
