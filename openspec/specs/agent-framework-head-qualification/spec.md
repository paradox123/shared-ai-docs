# agent-framework-head-qualification Specification

## Purpose
Define durable qualification of one evidence-ready draft head through deterministic checks, independent Codex reviews and at most three repairs in the original writer session, ending in readiness for human review or a concrete human handoff.
## Requirements
