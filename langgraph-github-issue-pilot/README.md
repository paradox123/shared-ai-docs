...
This package implements the first two local pilot slices: accept and claim an authenticated GitHub issue, then prepare a bounded evidence-aware assignment and run its implementer through Codex CLI in an isolated Git worktree.
